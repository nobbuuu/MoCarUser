...
import com.dream.moka.Bean.ThirdInfoBeanWX;
 ...
 * @date 2016/8/6.
 */
public class ThirdLoginPresenter extends RxPvPresenter<ThirdLoginContract.View> implements ThirdLoginContract.Presenter<ThirdLoginContract.View> , PlatformActionListener {

    private ApiService itApi;

    private static final String TAG = "ThirdLoginPresenter";

    @Inject
    public ThirdLoginPresenter(ApiService bookApi) {
        this.itApi = bookApi;
    }
...
//        SpUtils.savaUserInfo(Const.tdUserName, userName);
        mView.authorizeComplete(userId,userIcon,userName,unionId,name);
    ...
    public void onError(Platform platform, int i, Throwable throwable) {
        ...
        Log.e(TAG, "onError_msg="+throwable.toString());
