...
public class CustomHelper {
    ...
    public static void toPicture(TakePhoto takePhoto){
        INSTANCE(takePhoto, "600", "600", false, "200", "200").onClick(false);
    }
    public static void toCamara(TakePhoto takePhoto){
        INSTANCE(takePhoto, "600", "600", false, "200", "200").onClick(true);
    }
